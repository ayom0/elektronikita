                    ...
                    <div class="col-md-6">
                        <ul class="list-inline shop-top-menu pb-3 pt-1">
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none mr-3" href="#">Laptop</a>
                            </li>
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none mr-3" href="#">Gaming</a>
                            </li>
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none" href="#">Notebook</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="./assets/home/img/laptophome2.png">
                            ...
                            <div class="card-body">
                                <a href="shop-single.html" class="h3 text-decoration-none">Laptop ASUS ROG Zephyrus G14</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>Hitam/Silver/Putih</li>
                                    <li class="pt-2">
                                ...
                                <p class="text-center mb-0">Rp.19.999.999</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">

    ...
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="./assets/home/img/pchome.jpg" class="rounded-circle img-fluid border"></a>
                <h5 class="text-center mt-3 mb-3">Laptop</h5>
                <p class="text-center"><a class="btn btn-success">Lihat produk</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="./assets/home/img/pchome.jpg" class="rounded-circle img-fluid border"></a>
                <h2 class="h5 text-center mt-3 mb-3">Handphone</h2>
                <p class="text-center"><a class="btn btn-success">Lihar produk</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="./assets/home/img/pchome.jpg" class="rounded-circle img-fluid border"></a>
                <h2 class="h5 text-center mt-3 mb-3">PC rakitan</h2>
                <p class="text-center"><a class="btn btn-success">Lihat produk</a></p>
            </div>
        </div>
    </section>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            <img src="./assets/home/img/laptophome2.png" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                ...
                                <li class="text-muted text-right">Rp.20.000.000</li>
                            </ul>
                            <a href="shop-single.html" class="h2 text-decoration-none text-dark">Laptop ASUS ROG Zephyrus G14</a>
                            <p class="card-text">
                                Laptop dari gaming dari assus dengan performa yang ganas dan juga body yang tipis.
                            </p>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted">Reviews (73)</p>
                        </div>
                    </div>
                </div>
            </div>

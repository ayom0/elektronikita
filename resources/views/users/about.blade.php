...
<head>
    ...
    <link rel="stylesheet" href="assets/home/css/halo.css">
        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    ...
                    <a class="navbar-sm-brand text-light text-decoration-none" href="tel:010-020-0340">08123523</a>
                </div>
                <div>
        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-8 text-white">
                    <h1>Toko</h1>
                    <p>
                    JL.Tebo selatan,dekat pabrik gandung .Kualitas produk adalah utama kami 
                    dengan layanan nomer satu untuk para pelanggan.
                    </p>
                </div>
                <div class="col-md-4">
                    <img class="img-fluid" src="./assets/home/img/toko1.png" alt="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="container py-5">
        <div class="row text-center pt-5 pb-3">
            <div class="col-lg-6 m-auto">
                ...
                <p>
                    Berikut adalah layanan yang kami sediakan untuk pelanggan tercinta kami.
                </p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    ...
                    <h2 class="h5 mt-4 text-center">Pengiriman barang</h2>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    ...
                    <h2 class="h5 mt-4 text-center">Belanja dan pengembalian</h2>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    ...
                    <h2 class="h5 mt-4 text-center">Diskon dan bonus</h2>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    ...
                    <h2 class="h5 mt-4 text-center">24 Hari Service</h2>
                </div>
            </div>
        </div>
    </section>
